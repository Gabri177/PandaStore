...
var require_metadata = __commonJS({
  "node_modules/@vueuse/metadata/index.cjs"(exports) {
    "use strict";
    var packages$1 = {
      shared: {
        name: "shared",
    ...
    var packages = packages$1;
    var categories = categories$1;
    var functionNames = functions.map((f) => f.name);
    var categoryNames = Array.from(categories).sort((a, b) => categoriesOrder.indexOf(a) - categoriesOrder.indexOf(b)).sort((a, b) => a.startsWith("@") ? 1 : b.startsWith("@") ? -1 : 0);
    var coreCategoryNames = categoryNames.filter((f) => !f.startsWith("@"));
    var addonCategoryNames = categoryNames.filter((f) => f.startsWith("@"));
    function getFunction(name) {
      return metadata.functions.find((f) => f.name === name);
    }
    function getCategories(functions2) {
      return uniq(
        functions2.filter((i) => !i.internal).map((i) => i.category).filter(Boolean)
      ).sort(
...
var require_metadata2 = __commonJS({
  "node_modules/@vueuse/core/metadata.cjs"(exports, module) {
    module.exports = require_metadata();
  }
});
export default require_metadata2();
//# sourceMappingURL=@vueuse_core_metadata__cjs.js.map
